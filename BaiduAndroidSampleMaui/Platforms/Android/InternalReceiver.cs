...
using static BaiduAndroidSampleMaui.Platforms.Android.BaiduEvent;
...
//#endif
    ...
    internal class BaiduForegroundService : Service
    {
        ...
        public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
        {
            ...
            Log.Info("cBaiduForegroundService2", "OnStartCommand2");
            ...
            Log.Info("[Cmon]", $"{this as Context}");

            // Set notification builder
            var notificationBuilder = new BasicPushNotificationBuilder();
            notificationBuilder.SetChannelName("Notification");
            PushManager.SetDefaultNotificationBuilder(this, notificationBuilder);

            PushManager.StartWork(this, PushConstants.LoginTypeApiKey, baiduPushApiKey);
        ...
        private Notification BuildNotification()
        {
            ...
            if (OperatingSystem.IsAndroidVersionAtLeast(26))
            {
                ...
                if (this.GetSystemService(NotificationService) is NotificationManager notificationManager)
                {
